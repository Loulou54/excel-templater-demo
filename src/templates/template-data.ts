...
const getBalanceSheetData = (): BalanceSheetDataType => {
...
const getEstimateData = (): EstimateDataType => {
  const genDate = new Date();
  return {
    genDate,
...
const getInvoiceData = (): InvoiceDataType => {
  const genDate = new Date();
  return {
    genDate,
